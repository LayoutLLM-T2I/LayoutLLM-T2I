...
class Trainer:
    def __init__(self, config):
        ...
        # self.model.load_state_dict(saved_ckpt['model'], strict=False)
        ...
        data_path = '/storage_fast/lgqu/generation/dataset'

        dataset_train = ConCatDataset(config.train_dataset_names, data_path, train=True,
    ...
    def prepare_relation_phrases(self, batch_prompt, max_relas=5):
        ...
        # out = dict(
        #     "relation_embeddings": relation_embeddings.unsqueeze(0).repeat(batch_size, 1, 1)
        # )
    ...
    def get_input(self, batch):
        ...
        return z, t, context, inpainting_extra_input, grounding_extra_input, relations

    def run_one_step(self, batch):
        x_start, t, context, inpainting_extra_input, grounding_extra_input, relations = self.get_input(batch)
