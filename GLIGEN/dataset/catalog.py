...
class DatasetCatalog:
    def __init__(self, ROOT):
        ...
        #     "target": "dataset.dataset_kp.LayoutDataset",
        #     "train_params":dict(
        #         image_root = os.path.join(ROOT,'coco/images/train2017'),
        #         keypoints_json_path = os.path.join(ROOT,'coco/annotations/person_keypoints_train2017.json'),
        ...
        self.COCO2017Keypoint = {
            ...
            "train_params": dict(
                ...
                caption_json_path=os.path.join(ROOT, 'coco/annotations/captions_train2017.json'),
                preprocess_data_dir='/storage/sqwu/diffusion/GLIGEN/DATA'
        ),
        }
